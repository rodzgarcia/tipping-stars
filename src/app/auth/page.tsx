        ...
        <div className="card" style={{ padding: '2rem' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div>
              ...
              <input className="input" type="password" placeholder={mode === 'signup' ? (t.lang === 'pt' ? 'Mínimo 8 caracteres' : 'At least 8 characters') : '••••••••'} value={password} onChange={e => setPassword(e.target.value)} required minLength={8} />
            </div>
          ...
          {mode === 'signup' && (
            <p style={{ fontSize: '0.78rem', color: 'rgba(255,255,255,0.3)', textAlign: 'center', marginTop: '1rem' }}>
              {t.lang === 'pt'
                ? 'Após o cadastro, o administrador do torneio precisará aprovar sua conta antes de você começar a apostar.'
